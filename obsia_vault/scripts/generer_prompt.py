...
def construire_prompt(racine: Path, agents: list[dict], skills: list[dict]) -> str:
    ...
    a("")
    a("- Le coffre est en LECTURE SEULE. Aucune écriture directe : toute")
    a("  modification est proposée sous forme de patch soumis à revue humaine.")
    a("- Aucune suppression sans archivage préalable dans .archive/")
