...
|---|---|---|---|---|
| [assistant](../agents/assistant.md) | Agent de base du coffre OBSIA — orchestre la mémoire, crée des skills, et prépare les patches soumis à revue. | createur-de-skill, cloture-de-session, compilation-des-lecons, obsidian-manager, recherche, mermaid, cron, pdf, bureautique, diagnostic-linux, remediation-linux, conteneurs-docker, traefik, proxmox, sauvegardes, traitement-des-notes, cartographie-du-coffre, configuration-mcp | git-hub, chrome-devtools, obsidian, coffre-parent, searxng | non |
