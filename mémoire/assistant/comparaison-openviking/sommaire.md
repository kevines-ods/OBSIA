# Sommaire — comparaison-openviking

> Généré par `scripts/regenerate_sommaire.py` depuis le contenu des notes.
> Ne pas éditer à la main (cf. `VAULT-CONTRACT.md` §2).

8 notes, le 2026-09-03.

## Notes

| Note | Statut | Résumé |
|---|---|---|
| [Comparaison OBSIA / OpenViking](2026-09-03-comparaison-openviking.md) | 🟢 Analyse close. Six des sept pistes ont été appliquées… | Point d'entrée du projet : ce qu'est OpenViking, ce qu'OBSIA lui a pris, ce qu'il a refusé de lui prendre. Les sept… |
...
| [OpenViking, les sept observations](2026-09-03-openviking-observations.md) | 🟢 Évidence figée — constatée le 2026-09-03, non révisée… | Évidence relevée dans la documentation d'OpenViking : sept conventions de fichiers qu'OBSIA n'avait pas. Détachée le… |
